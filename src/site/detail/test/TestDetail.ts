...
class TestDetail implements AcqDetail {
    ...
    async extractItemDetail(url:string): Promise<ColtItem> {
        try {
            ...
            try {
                ...
                // makeColtItem생성
                await makeItem.makeColtItem(cItem, url, this.collectSite, '수집하는 사이트의 siteName', '수집하는 사이트의 stdCode', goodsName, itemNum, goodsCate,
