...
async function parsingItemList(categoryList, detailPage, pageNum, coltBaseUrlList){
    ...
    detailPage('div.products-page__content > div.products-page__list  div.catalog-product.ui-button-widget').each((index, content)=> {
        let bsItem = new ColtBaseUrlItem();
        ...
        bsItem.collectDay = dateUtils.currentDay();
        bsItem.expiredDt = dateUtils.expiredDt();
    
        bsItem.ColtBaseUrlCate.cate = categoryList.name;
        bsItem.ColtBaseUrlCate.cateUrl = categoryList.cateUrl;
        bsItem.ColtBaseUrlCate.regDt = dateUtils.currentDate();
    
        bsItem.ColtBaseUrlRank.rank = rank;
        bsItem.ColtBaseUrlRank.regDt = dateUtils.currentDate();
        ...
        bsItem.ColtShelfItem.disPrice = disPrice;
        bsItem.ColtShelfItem.totalEvalutCnt = totalEvalutCnt;
